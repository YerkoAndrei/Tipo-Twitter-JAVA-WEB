 ...
 * @author YerkoAndrei
 */
public class retwittear extends HttpServlet {
    @EJB
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        // aqui error de retweet si existe '#'. ni idea porque se corta el texto con ese caracter
        // si encuentra el error, favor mandar solucion a yerko.orellana04@inacapmail.cl
        String[] corteCom = completo.split("-");
        String texto = corteCom[0];
        String userRe = corteCom[1];
        ...
        if(texto.length() >= 1 && texto.length() <= 140)
        {
            ...
            co.setTexto(texto + salto +" Tuit anterior de: " + userRe);
